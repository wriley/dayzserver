/*
	...
	SM5 copied to EM1 for an Epoch supply missipon by Kerbo
*/
private ["_missName","_coords","_crash","_crate"];

//Name of the Mission
_missName = "Supply Humvee Crash";

//DZMSFindPos loops BIS_fnc_findSafePos until it gets a valid result
_coords = call DZMSFindPos;

[nil,nil,rTitleText,"A Humvee carrying building supplies has crashed!\nGo investigate the cause of the wreck!", "PLAIN",10] call RE;
...
sleep 1;
[_coords,2,5,"DZMSUnitsMinor"] call DZMSAISpawn;
sleep 1;
